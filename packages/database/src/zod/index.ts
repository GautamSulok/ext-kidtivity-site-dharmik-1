...
export const FeaturedChatScalarFieldEnumSchema = z.enum(['id','chatId','title','description','image','featured','isSelected','tier','created_at','updated_at']);

export const UserFavoritesScalarFieldEnumSchema = z.enum(['id','chatId','userId']);

export const ChatLogScalarFieldEnumSchema = z.enum(['id','chatId','userId','title','created_at']);
...
/////////////////////////////////////////
// FEATURED CHAT SCHEMA
/////////////////////////////////////////

export const FeaturedChatSchema = z.object({
  id: z.string(),
  chatId: z.string(),
  title: z.string(),
...
export type FeaturedChat = z.infer<typeof FeaturedChatSchema>
